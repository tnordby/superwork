...
UNION ALL
SELECT '✓ 30 customer-visible tasks'
UNION ALL
SELECT '✓ 80 hours estimated delivery'
UNION ALL
SELECT ''
UNION ALL
SELECT 'Milestones:'
UNION ALL
SELECT '1. Foundation & Access (4 tasks)'
UNION ALL
SELECT '2. Brand Assets & File Manager (3 tasks)'
UNION ALL
SELECT '3. Privacy, Domains & Email Setup (3 tasks)'
UNION ALL
SELECT '4. Forms & CTAs (3 tasks)'
UNION ALL
SELECT '5. Email & Landing Page Templates (2 tasks)'
UNION ALL
SELECT '6. Integrations & Workflows (3 tasks)'
UNION ALL
SELECT '7. Reporting & Handoff (5 tasks)';
