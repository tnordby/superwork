-- =============================================
-- SHARED ASSET LIBRARY MIGRATION (CLEAN VERSION)
-- =============================================
...
-- Drop workspace member policies
...
-- Drop asset category policies
drop policy if exists "Workspace members can view categories" on public.asset_categories;
drop policy if exists "Workspace owners and admins can manage categories" on public.asset_categories;
...
drop policy if exists "Users can create assets in their workspaces" on public.assets;
drop policy if exists "Users can update their own assets" on public.assets;
drop policy if exists "Workspace admins can delete workspace assets" on public.assets;

-- Drop asset share policies
drop policy if exists "Users can view shares for assets they can access" on public.asset_shares;
drop policy if exists "Asset owners can create shares" on public.asset_shares;
drop policy if exists "Asset owners can delete shares" on public.asset_shares;
