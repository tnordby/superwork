...
function ProjectsPageContent({ initialServiceTemplates }: ProjectsPageClientProps) {
      ...
      {activeTab === 'browse' && (
        <div>
          {serviceTemplates.length > 0 ? (
            ...
            // Fallback: offline / empty catalog — static list so the tab stays usable
            <>
              {/* Category Badges */}
              <div className="flex flex-wrap gap-4 mb-12">
                <button
...
export default function ProjectsPageClient(props: ProjectsPageClientProps) {
